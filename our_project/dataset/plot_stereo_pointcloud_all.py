...
input_folder = "${WORK_DIR}/our_project/dataset/test_dataset/EX01PM15/point_cloud"  # npyファイルが格納されているフォルダ
output_folder = "${WORK_DIR}/our_project/dataset/test_dataset/EX01PM15/plot_pointcloud"  # プロット結果を保存するフォルダ
