...
# 3D点群データの読み込み
npy_file_path = "${WORK_DIR}/data/coke_dataset_23_11/Routes_Scenario3_Town01_curved_Seed1000/Scenario3_Town01_curved_route0_11_23_20_02_59/lidar/0000.npy"  # npyファイルのパスを指定
...
# プロット結果を保存
output_file_path_xy = os.path.join(output_folder, "3d_scatter_plot_carla_xy_view.png")
