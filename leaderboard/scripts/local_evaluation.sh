export CARLA_ROOT=${1:-/home/khoi/research/transfuser/carla}
export WORK_DIR=${2:-/home/khoi/research/transfuser}
...
export CHECKPOINT_ENDPOINT=${WORK_DIR}/results/transfuser_longest6_3.json
...
export SAVE_PATH=${WORK_DIR}/results/local_evaluation_2
